...
{public float walkBobSpeed = 12f;
    ...
    void Start()
    {
        ...
        playerController.HandleMovement += HandleMovement;
        playerController.OnDisableVisual += OnDisableVisual;
    }
    ...
    private void HandleMovement(Vector2 input)
    {
        ...
        if (input.magnitude > 0.1f && playerController.currentState == PlayerController.PlayerState.Default)
        {
